...
for iBeta in range(nBeta):
    ...
    model_path = os.path.join(save_dir, f"GAE_iBeta_{iBeta+1}.pt")
    torch.save(model_i, model_path) # Save trained model
    print(f"Saved trained model for Beta {iBeta}.")
...
# Test - save learned betas
#savemat(analysis_type + '_learned_betas.mat',{'reconstructed':reconstructed_all})
